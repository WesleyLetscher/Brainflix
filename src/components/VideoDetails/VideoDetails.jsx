...
function HeroVideoText(props) {
    return ( <
        ...
        <
        div className = "main__video-details-views" > < img src = { ViewsIcon }
        alt = "Views Logo"
        className = "main__video-icon main__video-icon-views" / > { props.views } < /div> <
        div className = "main__video-details-likes" > < img src = { LikesIcon }
        alt = "Likes Logo"
        className = "main__video-icon main__video-icon-likes" / > { props.likes } < /div>     <
        /div> <
        /div> <
                ...
                return ( <
                    div className = "main__video-details" > {
                        this.state.currentVideoDetails.map(currentVideoDetailsInfo =>
                            <
                            HeroVideoText key = { currentVideoDetailsInfo.id }
                            title = { currentVideoDetailsInfo.title }
                            author = { currentVideoDetailsInfo.author }
                            date = { currentVideoDetailsInfo.date }
                            views = { currentVideoDetailsInfo.views }
                            likes = { currentVideoDetailsInfo.likes }
                            description = { currentVideoDetailsInfo.description }
                            /> )}           <
                            /div>       
                        );
                    };
